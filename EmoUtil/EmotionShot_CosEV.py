...
class EmotionShot_CosEV(object):
    """
    ...
    Emodictionary = ExtractUtil.ExtractEmotionalwordsUtil(dictFolder=GLOBAL_CECdictFolder)
    """
    类属性
    """
    ...
    def calculateShotVector(self, shotWordsList):
        ...
        for shotword in shotWordsList:  # 遍历shot中的词
            count4for += 1
            flagfind = False
            for emoword in EmotionShot_CosEV.Emodictionary:
...
if __name__ == '__main__':
    ...
    eShot = EmotionShot_CosEV(shotLocation=shotLocation)
